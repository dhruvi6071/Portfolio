...
function HeroSec() {
  return (
    <div
      id="Home"
      className="maincontainer pt-20 max-container bg-secondary w-full flex flex-col-reverse lg:flex-row justify-center items-center overflow-x-hidden px-4 sm:px-6 lg:px-20"
    >
      {/* Text Container */}
      <div className="textcontainer text-text1 font-outfit w-full flex flex-col items-center lg:items-start text-center lg:text-left relative mt-10 lg:mt-0 sm:px-e8 ml-12">
