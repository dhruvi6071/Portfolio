  ...
  return (
    ...
    >
      ...
      <div className="textcontainer text-text1 font-outfit w-full flex flex-col items-center lg:items-start text-center lg:text-left relative mt-10 lg:mt-0 sm:px-e8 lg:ml-12">
        <p className="greet text-xl sm:text-2xl md:text-3xl font-bold ">Hello, I am</p>
        <p className="name py-3 text-2xl sm:text-3xl md:text-4xl lg:text-7xl font-bold text-text2 ">
          Dhruvi Raj !!
        </p>
        <p className="intro py-1 text-2xl sm:text-xl md:text-2xl font-semibold ">
          Web Designer & Developer
        </p>
        <p className="t1 text-lg sm:text-base">A passionate software developer and</p>
        <p className="t1 text-lg sm:text-base font-roboto ">technology enthusiast</p>
      </div>

      {/* Image Container */}
      <div className="imgcontainer w-full flex justify-center items-center mt-10 lg:mt-0">
        <img
          src={ill3}
