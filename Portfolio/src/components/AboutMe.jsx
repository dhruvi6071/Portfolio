...
function AboutMe() {
  return (
    <div id="About%20us" className="min-h-screen flex flex-col-reverse lg:flex-row items-center justify-center bg-gradient-to-t from-third to-secondary py-12 lg:py-24 px-6 md:px-12 overflow-x-hidden">
